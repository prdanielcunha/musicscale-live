...
Open: richer Live Drop preview/transcoding; retention/permissions UI and policy presets; cloud/shared media source adapters and richer metadata/indexing for the Universal Library; complete neutral Announcement/Message domain; physical validation of section-marker quality across Holyrics/ProPresenter song structures; collaboration physical E2E across pastor/conductor/operator devices; physical cross-node throughput/latency validation with real church media files.
