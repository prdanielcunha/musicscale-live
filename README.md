...
Este é o repositório canônico e independente do **MusicScale Live**, a camada de execução ao vivo do MusicScale. Ele transforma planejamento, repertório e escala em operação de culto, mantendo identidade, organização, permissões e assinatura compartilhadas com o ecossistema MillionsNest, mas com bundle, deploy, runtime local e ciclo de engenharia próprios.
