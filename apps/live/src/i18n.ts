  ...
  pt: { translation: {
    ...
    liveDrop: {
      ...
      policy: {
        ...
        title: 'Você sabe exatamente o que fica armazenado',
        description: 'A retenção é aplicada pelo Live Node local. Aprovação continua sendo uma decisão do operador e arquivos expirados são removidos fisicamente do cache.',
        ...
        approvedHint: 'prontos offline; sem expiração por padrão',
  ...
  en: { translation: {
    ...
    liveDrop: {
      ...
      policy: {
        ...
        kicker: 'LIFECYCLE',
        title: 'Know exactly what stays stored',
        description: 'Retention is enforced by the local Live Node. Approval remains an operator decision and expired files are physically removed from cache.',
        ...
        approvedHint: 'offline-ready; no expiry by default',
  ...
  es: { translation: {
    ...
    liveDrop: {
      ...
      policy: {
        ...
        kicker: 'CICLO DE VIDA',
        title: 'Sepa exactamente qué queda almacenado',
        description: 'La retención la aplica el Live Node local. La aprobación sigue siendo decisión del operador y los archivos vencidos se eliminan físicamente del caché.',
        ...
        approvedHint: 'listos offline; sin vencimiento por defecto',
