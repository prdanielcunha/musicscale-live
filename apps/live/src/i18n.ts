...
const resources = {
  pt: { translation: {
    ...
    peerNodes: {
      ...
      description: 'Conecte os Live Nodes desta rede. Cada computador mantém seu app local e o MusicScale Live coordena tudo por capacidade.',
  ...
  en: { translation: {
    ...
    peerNodes: {
      ...
      description: 'Connect the Live Nodes on this network. Each computer keeps its local app while MusicScale Live coordinates them by capability.',
      computers: 'Computers',
  ...
  es: { translation: {
    ...
    peerNodes: {
      ...
      description: 'Conecte los Live Nodes de esta red. Cada computadora mantiene su app local y MusicScale Live coordina todo por capacidad.',
