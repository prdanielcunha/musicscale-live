...
const resources = {
  pt: { translation: {
    ...
    liveDrop: {
      ...
      routeRequired: 'Há mais de um provider de mídia. Defina o principal em Rotas antes de abrir um Live Drop.',
  ...
  en: { translation: {
    ...
    liveDrop: {
      ...
      routeRequired: 'More than one media provider is available. Choose the primary route before opening a Live Drop.',
  ...
  es: { translation: {
    ...
    liveDrop: {
      ...
      routeRequired: 'Hay más de un provider de medios. Defina el principal en Rutas antes de abrir un Live Drop.',
