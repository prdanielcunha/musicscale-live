...
const resources = {
  pt: { translation: {
    ...
    peerNodes: {
      ...
      title: 'Um Live, vários computadores',
      description: 'Conecte os Live Nodes desta rede. Cada computador mantém seu app local e o MillionsNest Live coordena tudo por capacidade.',
      ...
      addHint: 'Instale e abra o Live Node no outro PC e informe aqui o endereço local exibido por ele. O pareamento usa um PIN mostrado somente naquele computador.',
      addressPlaceholder: 'Ex.: 192.168.1.44:4317 ou pc-led.local:4317',
      connecting: 'Conectando…',
      connect: 'Conectar computador',
  ...
  en: { translation: {
    ...
    peerNodes: {
      ...
      title: 'One Live, multiple computers',
      description: 'Connect the Live Nodes on this network. Each computer keeps its local app while MillionsNest Live coordinates them by capability.',
      computers: 'Computers',
      ...
      addHint: 'Install and open Live Node on the other computer, then enter the local address it shows. Pairing uses a PIN displayed only on that computer.',
      addressPlaceholder: 'e.g. 192.168.1.44:4317 or led-pc.local:4317',
  ...
  es: { translation: {
    ...
    peerNodes: {
      ...
      title: 'Un Live, varias computadoras',
      description: 'Conecte los Live Nodes de esta red. Cada computadora mantiene su app local y MillionsNest Live coordina todo por capacidad.',
      ...
      addHint: 'Instale y abra Live Node en la otra computadora e ingrese aquí la dirección local que muestra. El emparejamiento usa un PIN visible solo allí.',
      addressPlaceholder: 'Ej.: 192.168.1.44:4317 o pc-led.local:4317',
      connecting: 'Conectando…',
      connect: 'Conectar computadora',
